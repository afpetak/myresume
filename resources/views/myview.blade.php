...
<head>
    ...
    <link rel="icon" href="meetme/img/afeptak.png" type="image/png">
    ...
    <div class="container box_1620">
        <div class="banner_inner d-flex align-items-center">
            <div class="banner_content">
                <div class="media">
                    <div class="d-flex">
                        <img src="meetme/img/afif.jfif" alt="">
                    </div>
                    <div class="media-body">
                        <div class="personal_text">
                            <h6>Hello Everybody, i am</h6>
                            <h3>Muhamad Afif Firdaus Zabri</h3>
                            <h4>Junior Developer</h4>
                            <p>Looking for the Internship places where i can gain my experience in IT fields and also can build up my career</p>
                            <ul class="list basic_info">
                                <li><a href="#"><i class="lnr lnr-calendar-full"></i> 2nd February, 1995</a></li>
                                <li><a href="#"><i class="lnr lnr-phone-handset"></i> +06 013 5200295</a></li>
                                <li><a href="#"><i class="lnr lnr-envelope"></i> afifmuhdafif@gmail.com</a></li>
                                <li><a href="#"><i class="lnr lnr-home"></i> Kajang, Selangor</a></li>
                            </ul>
                            <ul class="list personal_social">
                                <li><a href="https://www.facebook.com/afif.muhd"><i class="fa fa-facebook"></i></a></li>
                                <li><a href="https://www.twitter.com/afpetak"><i class="fa fa-twitter"></i></a></li>
                                <li><a href="https://www.linked.com/afpetak"><i class="fa fa-linkedin"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="row welcome_inner">
            <div class="col-lg-6">
                <div class="welcome_text">
                    ...
                    <p> 1.	Winning Best Project for E-stimewa Embrace The Difference under UITM (Game For Autism Kids)<br />2.	Mentor for Program Collaboration Uitm and SM Sains Tuanku Aishah (Python Instructor)<br />3.	Certificate Data Scientist and Data Analyst from DataCamp</p>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="wel_item">
            ...
            <div class="col-lg-6">
                <div class="tools_expert">
                    <div class="skill_main">
                        ...
                        <div class="skill_item">
                            <h4>PHP(Laravel) <span class="counter">50</span>%</h4>
                            <div class="progress_br">
                                <div class="progress">
                                    <div class="progress-bar" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                        ...
                        <div class="skill_item">
                            <h4>MySQL <span class="counter">50</span>%</h4>
                            <div class="progress_br">
                                <div class="progress">
                                    <div class="progress-bar" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                        ...
                        <div class="skill_item">
                            <h4>HTML <span class="counter">60</span>%</h4>
                            <div class="progress_br">
                                <div class="progress">
                        ...
                        <div class="skill_item">
                            <h4>JAVA <span class="counter">45</span>%</h4>
                            <div class="progress_br">
                                <div class="progress">
                    ...
                    <ul class="list">
                        <li>
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h4>Agensi Nuklear Malaysia</h4>
                                    <p>Junior Engineer <br />Bangi, Malaysia</p>
                                </div>
                            </div>
                        </li>
                    </ul>
                ...
                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    <ul class="list">
                        <li>
                            ...
                            <div class="media">
                                <div class="d-flex">
                                    <p>December 2013-December 2016</p>
                                </div>
                                <div class="media-body">
                                    <h4>Politeknik Sultan Azlan Shah</h4>
                                    <p>Diploma in Mechanical(Mechatronic)</p>
                                </div>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <p>Bachelor in Information Technology (Hons) Information System Engineering</p>
                                </div>
                            </div>
                        </li>
                    </ul>
